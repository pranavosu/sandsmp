...
/// Update a Sand cell. Attempts to move down, then diagonally down-left/right.
/// Swaps with Water (density displacement) or moves into Empty.
pub fn update_sand(api: &mut SandApi) {
    ...
    // Try diagonal: pick direction based on generation parity to reduce bias.
